...
variable "nsg_lb" {
  default = "nsg-pre-prod-lb"
}

variable "nsg_cms" {
  default = "nsg-pre-prod-cms-worker"
}

variable "nsg_web" {
  default = "nsg-pre-prod-web-worker"
}

variable "nsg_airs" {
  default = "nsg-pre-prod-airs-worker"
}

variable "nsg_careers" {
  default = "nsg-pre-prod-careers"
}

variable "nsg_api_gw" {
  default = "nsg-pre-prod-api-gw"
}

variable "nsg_db" {
  default = "nsg-pre-prod-db"
}

variable "nsg_bastion" {
  default = "nsg-pre-prod-bastion"
}

variable "nsg_gf_host" {
  default = "nsg-pre-prod-gfhost"
}

variable "nsg_redis" {
  default = "nsg-pre-prod-redis"
}

variable "nsg_k8s_api_endpoint" {
  default = "nsg-pre-prod-k8s-api-endpoint"
}

variable "nsg_web_pod" {
  default = "nsg-pre-prod-web-pod"
}

variable "nsg_cms_pod" {
  default = "nsg-pre-prod-cms-pod"
}

variable "nsg_airs_pod" {
  default = "nsg-pre-prod-airs-pod"
}

variable "nsg_apisix_pod" {
  default = "nsg-pre-prod-apisix-pod"
}

variable "nsg_apisix" {
  default = "nsg-pre-prod-apisix-worker"
}

variable "nsg_authentik_pod" {
  default = "nsg-pre-prod-authentik-pod"
}

variable "nsg_authentik" {
  default = "nsg-pre-prod-authentik-worker"
}
...
variable "npa_display_name" {
  ...
  type        = string
  default     = "pre-prod-subnet-connectivity-test"
}
...
variable "apisix_cluster_name" {
  description = "OKE cluster name."
  type        = string
  default     = "pre-prod-apisix-cluster"
}
...
variable "authentik_cluster_name" {
  description = "OKE cluster name."
  type        = string
  default     = "pre-prod-authentik-cluster"
}
